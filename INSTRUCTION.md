...
.toast--success { background: var(--teal-50);   color: var(--teal-800);   }
.toast--error   { background: var(--coral-50);  color: var(--coral-800);  }
.toast--info    { background: var(--gray-50);   color: var(--gray-800);   }
...
.btn--icon:hover { color: var(--color-text); opacity: 1; }
```
...
.docs-table td.pages { text-align: right; }
