...
import { openUploadModal } from "../views/upload";

export function renderToolbar(onRefresh: () => void): void {
  const toolbar = document.getElementById("toolbar")!;
  toolbar.innerHTML = `
    <h1 class="toolbar__title">Study Assistant</h1>
    <button class="btn btn--ghost" id="refresh-btn" title="Refresh">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M23 4v6h-6M1 20v-6h6M3.51 9a9 9 0 0114.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0020.49 15"></path></svg>
    </button>
  ...
  toolbar.querySelector("#refresh-btn")!.addEventListener("click", onRefresh);
  toolbar
